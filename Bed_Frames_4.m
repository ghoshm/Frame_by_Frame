...
% Colors 
cmap_2 = lbmap(max(group_tags)*2,'RedBlue'); % Generate a 2x color map 
...
% Adjust colours for WT Experiments
if max(group_tags) == 1
...
%% Figure - Parameter Distributions V3
    ...
    % Plot's Std Rather than SEM 
        % Note I've left the SEM Code in as this will probably be better
        % for more groups 
